...
namespace Syntra.Shared.Extensions {
	...
	public static class CloneExtensions {
		public static T MakeClone<T>(this T src) where T : class, new() {
			T clone = new T();
			clone.CopyFrom<T>(src);
			return clone;
		}
		public static T MakeClone<TInterface, T>(this TInterface src) where TInterface : class where T : class, TInterface, new() {
			T clone = new T();
			clone.CopyFrom<TInterface, T>(src);
			return clone;
		}
		public static bool CopyFrom<T>(this T dest, T src) where T : class { return dest.CopyFrom<T, T>(src); }
